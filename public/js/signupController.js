angular.module("BookBuddiesMod")
  .controller("signupController", function($scope, $uibModal, $http, apiService, dbService, $location, $uibModalInstance, $rootScope){
		    	...
		    	dbService.checkUser($scope.newUser.username).then(function(response) {
		    		if(response === "Username available") {
		    			...
		    			dbService.newUser($scope.newUser).then(function() {
		    				//Log user in!!!!!
		    				$rootScope.user = $scope.newUser.username;
